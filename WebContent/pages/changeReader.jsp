...
<script type="text/javascript">
	function check(form) {
		...
		if (form.borrowedNum.value < 0) {
			layer.msg('借书量不能为负数！', {
				time : 1000
			});
			form.borrowedNum.focus();
			return false;
		}
...
<body>
	...
	%>
	<iframe name="change_iframe" src="ChangeReader.java"
		style="width: 0; height: 0; border: none"></iframe>
	<div class="reg">
		<center>
			<br>
			<form name="change" action="/shujuku/ChangeReader?id=<%=id %>"
				...
				<table border="0">
					...
					<tr>
						<td>借&nbsp;&nbsp;书&nbsp;&nbsp;量：</td>
						<td><input type="text" name="borrowedNum"
							style="width: 50px" value="<%=reader.getBorrowedNum()%>"></td>
					</tr>
					<tr>
						<td>联系方式：</td>
